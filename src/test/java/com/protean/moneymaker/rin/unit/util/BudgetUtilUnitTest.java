...
//    convertBudgetsToDto
    ...
    void convertBudgetsToDto_GivenValidBudgets_ThenReturnFullDtos() {
        ...
        Budget budgetOne = new Budget(
                budgetCategory, "A Budget Name", ZonedDateTime.now(),
                ZonedDateTime.now().plusDays(5), frequencyType, BigDecimal.valueOf(35.02), true);
        budgetOne.setId(1L);

        Budget budgetTwo = new Budget(
                budgetCategory, "A Second Budget Name", ZonedDateTime.now(),
                ZonedDateTime.now().plusDays(8), frequencyType, BigDecimal.valueOf(22.22), true);
        budgetTwo.setId(2L);
