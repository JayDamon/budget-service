...
class TransactionServiceImplUnitTest {
    ...
    void getAllTransactionDtos_GivenCompleteTransactionsFound_ThenMapCompleteDto() {
        ...
        for (TransactionDto dto : transactionDtos) {
            ...
            assertThat(dto.getTransactionCategory().getTransactionCategoryId(), is(equalTo(11L)));
            assertThat(dto.getTransactionCategory().getTransactionCategoryName(), is(equalTo("TransactionCategoryOne")));
            assertThat(dto.getTransactionCategory().getSubCategory().getId(), is(equalTo(10L)));
            assertThat(dto.getTransactionCategory().getSubCategory().getName(), is(equalTo("BudgetSubCategoryOne")));
            assertThat(dto.getTransactionCategory().getSubCategory().getTransactionTypeName(), is(equalTo("TransactionTypeOne")));
            ...
            assertThat(dto.getRecurringTransaction().getBudgetSubCategory().getTransactionTypeName(), is(equalTo("TransactionTypeOne")));
            assertThat(dto.getRecurringTransaction().getTransactionCategory().getTransactionCategoryId(), is(equalTo(11L)));
            assertThat(dto.getRecurringTransaction().getTransactionCategory().getTransactionCategoryName(), is(equalTo("TransactionCategoryOne")));
            assertThat(dto.getRecurringTransaction().getTransactionCategory().getSubCategory().getId(), is(equalTo(10L)));
            assertThat(dto.getRecurringTransaction().getTransactionCategory().getSubCategory().getName(), is(equalTo("BudgetSubCategoryOne")));
            assertThat(dto.getRecurringTransaction().getTransactionCategory().getSubCategory().getTransactionTypeName(), is(equalTo("TransactionTypeOne")));
